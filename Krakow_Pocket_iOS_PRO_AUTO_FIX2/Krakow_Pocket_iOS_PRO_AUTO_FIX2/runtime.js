...
function loadVisuals(){if(!document.querySelector('link[href*="visuals.css"]')){const l=document.createElement("link");l.rel="stylesheet";l.href="./visuals.css?v=610";document.head.appendChild(l)}if(!document.querySelector('script[src*="visuals.js"]')){const s=document.createElement("script");s.src="./visuals.js?v=610";s.async=true;document.body.appendChild(s)}}
...
window.addEventListener("load",loadVisuals,{once:true});
})();
