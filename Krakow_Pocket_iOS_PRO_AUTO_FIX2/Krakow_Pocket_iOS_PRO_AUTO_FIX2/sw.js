...
self.addEventListener("fetch",e=>{
  ...
  if(u.hostname==="cdn.jsdelivr.net"&&(u.pathname.includes("leaflet@1.9.4")||u.pathname.includes("pdf-lib@1.17.1")||u.pathname.includes("tesseract.js@5")||u.pathname.includes("tesseract.js-core")||u.pathname.includes("@tesseract.js-data/")||u.pathname.includes("pdfjs-dist@4.10.38"))){
