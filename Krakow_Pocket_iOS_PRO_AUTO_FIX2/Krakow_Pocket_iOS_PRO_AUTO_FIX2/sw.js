...
self.addEventListener("fetch",e=>{
  ...
  if(u.hostname==="cdn.jsdelivr.net"&&(u.pathname.includes("leaflet@1.9.4")||u.pathname.includes("pdf-lib@1.17.1"))){
