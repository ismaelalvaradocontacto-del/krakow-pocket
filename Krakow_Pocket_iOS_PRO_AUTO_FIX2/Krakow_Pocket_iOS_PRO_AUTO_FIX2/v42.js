...
function loadV43(){if(!document.querySelector('link[href*="v43.css"]')){const l=document.createElement("link");l.rel="stylesheet";l.href="./v43.css?v=4300";document.head.appendChild(l)}if(!document.querySelector('script[src*="v43.js"]')){const s=document.createElement("script");s.src="./v43.js?v=4300";document.body.appendChild(s)}}
function polish(){document.documentElement.classList.add("kp-rpg-v42");renderStatusLine();tidyLabels();loadV43();const v=$("#settingsVersion");if(v)v.textContent="Kraków Pocket · v4.3 · juego integrado"}
