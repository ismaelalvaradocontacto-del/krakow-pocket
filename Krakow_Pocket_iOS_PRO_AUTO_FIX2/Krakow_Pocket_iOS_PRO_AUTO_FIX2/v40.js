...
function loadV41(){if(!document.querySelector('link[href*="v41.css"]')){const l=document.createElement("link");l.rel="stylesheet";l.href="./v41.css?v=4100";document.head.appendChild(l)}if(!document.querySelector('script[src*="v41.js"]')){const s=document.createElement("script");s.src="./v41.js?v=4100";document.body.appendChild(s)}}
function polish(){document.documentElement.classList.add("kp-rpg-v40");renderHud();addSectionTitle("#home",".kp-rpg-actions","Acciones de aventura");addSectionTitle("#mapPanel",".poi-list","Lugares cercanos");addSectionTitle("#quests","#questList","Encargos disponibles");addSectionTitle("#diary","#storyList","Crónica desbloqueada");addSectionTitle("#budget","#categoryBars","Inventario de gasto");const ver=$("#settingsVersion");if(ver)ver.textContent="Kraków Pocket · v4.1 · auditoría visual";loadV41()}
