...
function loadV47(){if(!document.querySelector('link[href*="v47.css"]')){const l=document.createElement("link");l.rel="stylesheet";l.href="./v47.css?v=4700";document.head.appendChild(l)}if(!document.querySelector('script[src*="v47.js"]')){const s=document.createElement("script");s.src="./v47.js?v=4700";document.body.appendChild(s)}}
...
function fixChrome(){document.documentElement.classList.add("kp-rpg-v46");fixPortrait();fixQuestMap();loadV47();const version=$("#settingsVersion");if(version)version.textContent="Kraków Pocket · v4.7"}
